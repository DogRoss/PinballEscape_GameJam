...
public class SnowFill : MonoBehaviour
{
    ...
    void Update()
    {
        snow = (RenderTexture)meshRenderer.material.GetTexture("_Splat");
        temp = RenderTexture.GetTemporary(snow.width, snow.height, 0, RenderTextureFormat.ARGBFloat);
